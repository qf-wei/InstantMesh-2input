...
#     cache_dir=model_cache_dir,
# )
unet_ckpt_path = "recon-1-2-61000-v1.ckpt"
...
def preprocess(input_image, input_image2, do_remove_background):
    ...
    rembg_session2 = rembg.new_session() if do_remove_background else None
    if do_remove_background:
        input_image = remove_background(input_image, rembg_session)
        input_image = resize_foreground(input_image, 0.4)

        input_image2 = remove_background(input_image2, rembg_session2)
        input_image2 = resize_foreground(input_image2, 0.4)
...
def make3d(images):
    global model
    # reduce the image size to 640x960
    print(images.size)
    images = images.resize((640, 960))
    print(images.size)
